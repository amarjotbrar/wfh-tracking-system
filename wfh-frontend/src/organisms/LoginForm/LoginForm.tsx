  ...
  return (
    <div className={'LoginContainer ' + user}>
        ...
        <form onSubmit={user == 'System'? handleSystem : handleOrganization}>
          <Input disabled={user == 'System'? true : false} type="text" placeholder='Organization' onChange={(e: InputFeild)=>{setOrg(e.target.value)}}></Input>
          <Input type="email" placeholder='E-mail' onChange={(e: InputFeild)=>{setEmail(e.target.value)}}></Input>

          <div className="otpContainer">
            <Input type='text' onChange={(e:InputFeild)=>{setOtp(e.target.value)}} placeholder='OTP'></Input>
